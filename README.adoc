...
(Need to look document properly)
...
+
which has the apps running from a previous `dapr init`, IIRC.
+
NOTE: what I don't yet know is how to stop then restart dapr, other than uninstalling and re-init'ing (!)
